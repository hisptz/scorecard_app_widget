...
export default function ScorecardTableBody({orgUnits, dataEngine}:any) {
        ...
        <DataTableBody>
            {
                <Fragment>
                    {tableOrientation === Orientation.ORG_UNIT_VS_DATA ? (
                        <Fragment>
                            {filteredOrgUnits?.map((orgUnit:any, index:number) => (
                                <ParentOrgUnitRow
                                    index={index}
                        ...
                        filteredDataHolders?.map(({id, dataSources}:any, index:number) => (
                            <DataSourceRow
                                index={index}
                                dataEngine={dataEngine}
                                orgUnits={orgUnits}
